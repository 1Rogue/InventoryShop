...
public class Updater {
    ...
    private final String TITLE_VALUE = "name"; // Gets remote file's title
    private final String LINK_VALUE = "downloadUrl"; // Gets remote file's download link
    private final String TYPE_VALUE = "releaseType"; // Gets remote file's release type
    private final String VERSION_VALUE = "gameVersion"; // Gets remote file's build version
    private final String QUERY = "/servermods/files?projectIds="; // Path to GET
    private final String HOST = "https://api.curseforge.com"; // Slugs will be appended to this to get to the project's RSS feed
    private String[] noUpdateTag = {"-DEV", "-PRE", "-SNAPSHOT"}; // If the version number contains one of these, don't update.
    private final int BYTE_SIZE = 1024; // Used for downloading files
